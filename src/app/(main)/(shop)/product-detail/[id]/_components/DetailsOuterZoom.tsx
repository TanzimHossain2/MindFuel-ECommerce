...
import SliderZoomOuter from "./SliderZoomOuter";
import Quantity from "@/components/shared/product/Quantity";

interface IProduct {
  product: IProductDetail;
}

export default function DetailsOuterZoom({ product }: IProduct) {
              ...
              <div className="tf-product-info-wrap position-relative">
                ...
                <div className="tf-product-info-list other-image-zoom">
                  ...
                  <div className="tf-product-info-quantity">
                    ...
                    <Quantity productId={product.id} key={product.id} />
                  </div>
